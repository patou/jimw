...
class Zym_Service_Scribd_Document extends Zym_Service_Scribd_Abstract
{
    ...
    public function upload($file, $docType = null, $access = null, $revisionId = null)
    {
        ...
        $this->_id        = (int)    $response->doc_id;
        $this->_accessKey = (string) $response->access_key;
        if (isset($response->secret_password)) {
            $this->_secretPassword = (string) $response->secret_password;
        }
    ...
    {
        $this->_restGet('docs.changeSettings', $metadata, array('doc_ids' => $this->getId()));
