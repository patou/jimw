...
CREATE TABLE "{PREFIX}site" ( "site_id" INTEGER NOT NULL PRIMARY KEY, "tree_id" int(11) NOT NULL default '0' , "default_tree_id" INT(11) NOT NULL default '0', "domain_id" INT(11) NOT NULL, "site_parentid" INT(11) NOT NULL DEFAULT '0', "site_access" tinyint(4) NOT NULL default '0' , "site_name" varchar(64) NOT NULL default 'site_domaine' , "site_path" varchar(255) NOT NULL default '', "site_template" VARCHAR(255) NOT NULL default 'template' );
...
CREATE TABLE "{PREFIX}tree" ( "tree_id" INTEGER NOT NULL PRIMARY KEY, "tree_parentid" int(11) NOT NULL default '0' , "tree_lft" int(11) NOT NULL , "tree_rgt" int(11) NOT NULL , "tree_order" int(11) NOT NULL default '0' , "site_id" int(11) default '0' , "module_id" int(11) default '0' , "module_path" VARCHAR(32) NOT NULL, "tree_pagetitle" varchar(255) NOT NULL default '' , "tree_menutitle" varchar(32) NOT NULL default '' , "tree_icon" varchar(127) NOT NULL default '' , "tree_image" varchar(127) NOT NULL default '' , "tree_alias" varchar(255) NOT NULL default '' , "tree_controller" varchar(255) NOT NULL default '' , "tree_description" mediumtext NOT NULL , "user_id" int(11) default '0' , "tree_status" tinyint(4) NOT NULL default '0' , "tree_version" int(11) NOT NULL default '0' , "tree_type" tinyint(4) NOT NULL default '0' , "tree_param" tinytext NOT NULL , "tree_creationdate" datetime NOT NULL default '1900-01-01 00:00:00' , "tree_editiondate" datetime NOT NULL default '1900-01-01 00:00:00' );
...
CREATE TABLE "{PREFIX}template" ( "template_id" INTEGER NOT NULL PRIMARY KEY, "template_id" int(11) default '0' , "site_id" INT(11) NOT NULL , "template_path" varchar(255) NOT NULL, "template_config" text NOT NULL );
