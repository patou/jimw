...
function CX(e){var a,c,d;this.a.qb();try{d=ld(e);fC(this.a,wX(this,d));}catch(a){a=ve(a);if(le(a,32)){c=a;fC(this.a,nv(new yt(),'Syntax Error ('+c.a+') in '+e));}else throw a;}}
function rX(){}
...
function l0(e){var a,b,c,d;c=(iV(),oV);a=ke(e,33);if(a===this.a){fY(c,'/tree/add/ext/ajax','New');return;}else if(a===this.e)EZ(new CZ(),t()+'/tree/list/ext/ajax?'+aj(),this.f);else{b=this.f.b;if(le(b,34)){d=ke(b,34);if(a===this.c){fY(c,'/tree/edit/ext/ajax/id/'+d.a,dG(d));}else if(a===this.b)fY(c,'/tree/delete/ext/ajax/id/'+d.a,dG(d));}}}
function g0(){}
