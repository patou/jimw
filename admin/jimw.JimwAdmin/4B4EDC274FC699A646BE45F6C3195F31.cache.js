...
function jY(d){var a,c;this.a.ob();try{c=ld(d);oC(this.a,dY(this,c));}catch(a){a=ve(a);if(le(a,33)){a;oC(this.a,tv(new Et(),'Syntax Error in '+d));}else throw a;}}
function EX(){}
...
function y0(e){var a,b,c,d;c=(vV(),BV);a=ke(e,34);if(a===this.a){sY(c,'/tree/add/ext/ajax','New');return;}else if(a===this.e)l0(new j0(),t()+'/tree/list/ext/ajax?'+bj(),this.f);else{b=this.f.b;if(le(b,35)){d=ke(b,35);if(a===this.c){sY(c,'/tree/edit/ext/ajax/id/'+d.a,mG(d));}else if(a===this.b)sY(c,'/tree/delete/ext/ajax/id/'+d.a,mG(d));}}}
function t0(){}
