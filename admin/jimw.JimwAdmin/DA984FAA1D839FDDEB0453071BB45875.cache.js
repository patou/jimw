...
function hY(d){var a,c;this.a.pb();try{c=ld(d);gC(this.a,bY(this,c));}catch(a){a=ve(a);if(le(a,33)){a;gC(this.a,mv(new xt(),'Syntax Error in '+d));}else throw a;}}
function CX(){}
...
function w0(e){var a,b,c,d;c=(tV(),zV);a=ke(e,34);if(a===this.a){qY(c,'/tree/add/ext/ajax','New');return;}else if(a===this.e)j0(new h0(),t()+'/tree/list/ext/ajax?'+aj(),this.f);else{b=this.f.b;if(le(b,35)){d=ke(b,35);if(a===this.c){qY(c,'/tree/edit/ext/ajax/id/'+d.a,eG(d));}else if(a===this.b)qY(c,'/tree/delete/ext/ajax/id/'+d.a,eG(d));}}}
function r0(){}
