...
if(Ext.ux.UploadPanel){
    Ext.apply(Ext.ux.UploadPanel.prototype, {
        ...
        clickStopText:'Cliquer pour arréter l\'envoi',
        emptyText:'Pas de fichiers',
        errorText:'Erreur',
        fileQueuedText:'Le fichier <b>{0}</b> est prét pour l\'envoi' ,
...
if(Ext.ux.FileTreeMenu){
    ...
    openSelfText:'Ouvrir dans cette fenêtre',
    openText:'Ouvrir',
...
if(Rged) {
	Ext.apply(Rged.prototype, {
        logoutText: 'Déconnexion',
        foldersText: 'Dossiers',
        filesText: 'Fichiers',
        nameText: 'Nom',
        sizeText: 'Size',
