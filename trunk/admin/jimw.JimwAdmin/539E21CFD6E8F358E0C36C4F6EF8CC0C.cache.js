...
function sX(d){var a,c;this.a.ob();try{c=ld(d);dC(this.a,mX(this,c));}catch(a){a=ve(a);if(le(a,33)){a;dC(this.a,lv(new wt(),'Syntax Error in '+d));}else throw a;}}
function hX(){}
...
function b0(e){var a,b,c,d;c=(EU(),eV);a=ke(e,34);if(a===this.a){BX(c,'/tree/add/ext/ajax','New');return;}else if(a===this.e)uZ(new sZ(),t()+'/tree/list/ext/ajax?'+aj(),this.f);else{b=this.f.b;if(le(b,35)){d=ke(b,35);if(a===this.c){BX(c,'/tree/edit/ext/ajax/id/'+d.a,bG(d));}else if(a===this.b)BX(c,'/tree/delete/ext/ajax/id/'+d.a,bG(d));}}}
function CZ(){}
