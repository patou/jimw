...
!!! AUTHENTICATION IS NOT SECURITY IT IS ONLY A MEANS
!!! OF PASSING A USER NAME TO THE CONNECTOR AND LOCKING
!!! THE USER INTO THEIR OWN FOLDER. THE DEFAULT AUTHENTICATION
!!! HANDLER CAN BE COMPROMISED USING A REPLAY ATTACK WITH IP
!!! SPOOFING, OR BY OTHER USERS SHARING THE SAME CONNECTION.
!!! HAVING SAID THIS IT IS STILL BETTER THAN NOTHING.
...
setup be default to be /FCKeditor/data this can be changed 
