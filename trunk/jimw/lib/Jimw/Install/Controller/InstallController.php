...
class InstallController extends Jimw_Install_Action
{
    ...
    public function configurationAction ()
    {
        ...
        if ($req->isPost() && $form->isValid($req->getPost())) {
            ...
            $form->populate(array('debug' => defined('JIMW_DEBUG_MODE') , 'install_protect' => defined('JIMW_INSTALL_PROTECT_DOMAIN') , 'rewrite' => defined('JIMW_URL_REWRITING') , 'utf8' => defined('JIMW_UTF8') , 'default_lang' => defined('JIMW_LANG') , 'akismet_key' => defined('JIMW_AKISMET_KEY') ? JIMW_AKISMET_KEY : '' , 'akismet_url' => defined('JIMW_AKISMET_URL') ? JIMW_AKISMET_URL : ''));
        }
        $this->view->form = $form;
    }
}
