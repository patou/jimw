...
class SystemController extends Jimw_Install_Action
{
    ...
    {
        $const_default = array('JIMW_DEBUG_MODE' => false , 'JIMW_DEFAULT_EXT' => 'phtml' , 'JIMW_URL_REWRITING' => true , 'JIMW_URL_MODULE_PATH' => 'module' , 'JIMW_URL_DEFAULT_PATH' => 'default' , 'JIMW_TIMEZONE' => 'Europe/Paris' , 'JIMW_LANG' => 'fr');
        $const = array();
