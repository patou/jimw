...
class Jimw_View_Helper_NavigMenu extends Zend_View_Helper_Navigation_Menu
{
    ...
    /**
     * Html added before the text in the link
     * @var string
     */
    protected $_prependHtml = '';
    /**
     * Html added after the text in the link
     * @var string
     */
    ...
    {
     	if (isset($options['prependHtml'])) {
            $this->setPrependHtml($options['prependHtml']);
        }
    	if (isset($options['appendHtml'])) {
            $this->setAppendHtml($options['appendHtml']);
        }
    	return parent::_normalizeOptions($options);
    }
    
    /**
	 * @return the $prependHtml
	 */
	...
	/**
	 * @param $prependHtml the $prependHtml to set
	 */
	...
	/**
	 * @param $appendHtml the $appendHtml to set
	 */
