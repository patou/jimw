...
class Jimw_Site_Route_Get extends Zend_Controller_Router_Route_Module
{
     ...
     */
    public function __construct ($defaults = array(), Zend_Controller_Dispatcher_Interface $dispatcher = null, Zend_Controller_Request_Abstract $request = null, $filename = '')
    {
        $this->_filename = $filename;
    ...
    protected function _setRequestKeys ()
    {
        ...
        if (null !== $this->_dispatcher) {
            $this->_defaults += array($this->_controllerKey => $this->_dispatcher->getDefaultControllerName() , $this->_actionKey => $this->_dispatcher->getDefaultAction() , $this->_aliasKey => $this->_dispatcher->getDefaultAlias() , $this->_moduleKey => $this->_dispatcher->getDefaultModule() , $this->_extKey => $this->_dispatcher->getDefaultExt());
        }
        $this->_keysSet = true;
    }
    /**
