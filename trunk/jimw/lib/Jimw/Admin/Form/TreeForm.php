...
class Jimw_Admin_Form_TreeForm extends Jimw_Form
{
    public function __construct ($options = null)
    {
        ...
        if (JIMW_DEBUG_MODE) {
            $this->addElements(array('tree_lft' => array('type' => 'text' , 'options' => array('label' => 'tree_lft')) , 'tree_rgt' => array('type' => 'text' , 'options' => array('label' => 'tree_rgt')) , 'tree_order' => array('type' => 'text' , 'options' => array('label' => 'tree_order')) , 'tree_param' => array('type' => 'text' , 'options' => array('label' => 'tree_param')) , 'tree_creationdate' => array('type' => 'text' , 'options' => array('label' => 'tree_creationdate')) , 'tree_editiondate' => array('type' => 'text' , 'options' => array('label' => 'tree_creationdate')) , 'site_id' => array('type' => 'Site' , 'options' => array('label' => 'site_id'))));
