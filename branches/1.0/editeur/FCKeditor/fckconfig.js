...
FCKConfig.ContextMenu = ['Generic','Link','Anchor','Image','TableCell','Table'] ;
...
FCKConfig.LinkBrowserURL = './editeur/filemanager/browser.html' ;
FCKConfig.LinkBrowserWindowWidth	= FCKConfig.ScreenWidth * 0.7 ;		// 70%
FCKConfig.LinkBrowserWindowHeight	= FCKConfig.ScreenHeight * 0.7 ;	// 70%

FCKConfig.ImageBrowser = true ;
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + '../../filemanager/browser.html' ;
